...
import com.example.katherine_qj.xiyou_library.IModel.IRentModel;
...
public class RentActivityModel implements IRentModel {
    ...
    public void getRentJsonString(final String session, final Handler handler) {
        ...
        final Request request = new Request.Builder()
                .url("https://api.xiyoumobile.com/xiyoulibv2/user/rent")
                .post(formBody)
                .tag("rent")
                .build();
